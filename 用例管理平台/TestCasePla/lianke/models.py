...
class Projectlianke(models.Model):
    """
    项目版本信息
    """
...
class TestCaselianke(models.Model):
    """
    测试用例
    """
    ...
    project = models.ForeignKey(Projectlianke, on_delete=models.CASCADE, default="默认项目", blank=True, verbose_name="所属项目")
